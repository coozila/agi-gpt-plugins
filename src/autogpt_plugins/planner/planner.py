...
def check_plan():
    ...
    workdir = os.path.join(
        current_working_directory, "alpha", "auto_gpt_workspace", "plan.md"
    )
...
def update_plan():
    ...
    current_working_directory = os.getcwd()
    workdir = os.path.join(current_working_directory, 'alpha', 'auto_gpt_workspace', 'plan.md')
...
def create_task(task_id=None, task_description: str = None, status=False):
    ...
    current_working_directory = os.getcwd()
    workdir = os.path.join(
        current_working_directory, "alpha", "auto_gpt_workspace", "tasks.json"
    )
    file_name = workdir
